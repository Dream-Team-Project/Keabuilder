...
<template>
    <div>
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <div class="bw-avatar-content bw-change-color-badge" >
                            ...
                            <div class="bw-avatar__badge isSlot top-right">
                                28
                            </div>
                        </div>                     
                    </li>
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown" aria-expanded="false">
                            <div class="user-nav d-sm-flex d-none">
                                <span class="user-name">{{bwname}}</span>
                                <span class="user-status text-muted">Available</span>
                            </div>
                            <span>
                                <div class="bw-avatar-content bw-change-color-badge">
                                    <div class="bw-avatar" @click="showoffcanvasoverlay">
                                        <img v-bind:src="'images/profile/avatar.png'" alt="">
                                    </div>
                                </div>
                            </span>
                        </a>
            ...
            <div class="bw-sidebar">
                ...
                <div class="bw-sidebar__group" :class="{ 'open' : isOpen }" @click="isOpen = !isOpen" >
                    ...
                    <div class="bw-sidebar__group__content v-enter-to kb-padinglft" :style="{height: isOpen ? '100%' : '0px'}"> 
                        ...
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('mailchimp')" :class="{ active:isActive('mailchimp') }">
                            <div class="bw-sidebar__item__icon">
                                <img src="/images/sidebaricons/mailchimp.svg" class="img-fluid">                             
                            </div>
                            <div class="bw-sidebar__item__text">
                                Mailchimp
                            </div>
                        </button> 
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('caltweet')" :class="{ active:isActive('caltweet') }">
                            <div class="bw-sidebar__item__icon">
                                <img src="/images/sidebaricons/caltweet.svg" class="img-fluid">                             
                            </div>                           
                            <div class="bw-sidebar__item__text">
                                Caltweet
                            </div>
                        </button>
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('calendly')" :class="{ active:isActive('calendly') }">
                             <div class="bw-sidebar__item__icon">
                                <img src="/images/sidebaricons/calendly.svg" class="img-fluid">                             
                            </div>
                            <div class="bw-sidebar__item__text">
                                Calendly
                            </div>
                        </button>
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('zoho')" :class="{ active:isActive('zoho') }">
                             <div class="bw-sidebar__item__icon">
                                <img src="/images/sidebaricons/zoho.svg" class="img-fluid">                             
                            </div>
                            <div class="bw-sidebar__item__text">
                                Zoho
                            </div>
                        </button>
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('hubspot')" :class="{ active:isActive('hubspot') }">
                             <div class="bw-sidebar__item__icon">
                                <img src="/images/sidebaricons/hubspot.svg" class="img-fluid">                             
                            </div>
                            <div class="bw-sidebar__item__text">
                                Hubspot
                            </div>
                        </button>
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('crmmore')" :class="{ active:isActive('crmmore') }">
                            <div class="bw-sidebar__item__icon"><i class="fas fa-external-link-square-alt"></i></div>
                            <div class="bw-sidebar__item__text">
                                More
                            </div>
                        </button>
                ...
                <div class="bw-sidebar__group" :class="{ 'open' : isOpen2 }" @click="isOpen2 = !isOpen2" >
                    ...
                    <div class="bw-sidebar__group__content v-enter-to kb-padinglft" :style="{height: isOpen2 ? '100%' : '0px'}"> <button
                        ...
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('mysupportrequest')" :class="{ active:isActive('mysupportrequest') }">
                            <div class="bw-sidebar__item__icon"> <i class="fas fa-comments"></i></div>
                            <div class="bw-sidebar__item__text">
                                My Support Request
                            </div>
                        </button> 
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('whatsnew')" :class="{ active:isActive('whatsnew') }">
                            <div class="bw-sidebar__item__icon"><i class="fas fa-gifts"></i></div>
                            <div class="bw-sidebar__item__text">
                                What's New
                            </div>
                        </button>
                ...
                <div class="bw-sidebar__group" :class="{ 'open' : isOpen3 }" @click="isOpen3 = !isOpen3">
                    ...
                    <div class="bw-sidebar__group__content v-enter-to kb-padinglft" :style="{height: isOpen3 ? '100%' : '0px'}"> <button
                        ...
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('myaccountsettings')" :class="{ active:isActive('myaccountsettings') }">
                            <div class="bw-sidebar__item__icon"> <i class="fas fa-user-cog"></i></div>
                            <div class="bw-sidebar__item__text">
                                My Account Settings
                            </div>
                        </button> 
                        <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('followupfunnel')" :class="{ active:isActive('followupfunnel') }">
                            <div class="bw-sidebar__item__icon"><i class="fas fa-user-cog"></i></div>
                            <div class="bw-sidebar__item__text">
                                Follow Up Funnels
                            </div>
                ...
                <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('qaadvice')" :class="{ active:isActive('qaadvice') }">
                    <div class="bw-sidebar__item__icon">
                    <i class="fas fa-chalkboard-teacher"></i>
                    </div>
                    <div class="bw-sidebar__item__text">
                        Q&As, Advice and Troubleshooting
                    </div>
                </button>
                <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('trainingresources')" :class="{ active:isActive('trainingresources') }">
                    <div class="bw-sidebar__item__icon">
            ...
            <form>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                        <!--begin::Scroll-->
                        <div class="scroll pr-7 mr-n7 ps ps--active-y" data-scroll="true" data-height="300" data-mobile-height="200" style="height: 300px;">
                            <!--begin::Item-->
                    ...
                    <div class="tab-pane" id="topbar_notifications_events" role="tabpanel">
                        <!--begin::Nav-->
                        <div class="navi navi-hover scroll my-4 ps" style="height: 300px;">
                            <!--begin::Item-->
                            ...
                            <a href="#" class="navi-item">
                                <div class="navi-link">
                                    <div class="navi-icon mr-2">
                                        <i class="fas fa-fax text-success"></i>
                                    </div>
                                    <div class="navi-text">
                                        <div class="font-weight-bold">New report has been received</div>
                                        <div class="text-muted">23 hrs ago</div>
        ...
        <transition name="slide">
            <div class="bw-userdetails" v-if="offcanvasoverlay">
                <div id="kt_quick_user" class="offcanvas offcanvas-right p-4 offcanvas-on">
                    <!--begin::Header-->
                    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-2" kt-hidden-height="40" style="">
                        <h3 class="font-weight-bold m-0">User Profile 
                        <small class="text-muted font-size-sm ml-2">12 messages</small></h3>
                        <a href="#" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_user_close" @click="hideoverlay">
                            <i class="fas fa-times text-muted"></i>
                        </a>
                    </div>
                    <!--end::Header-->
                    <!--begin::Content-->
                    <div class="offcanvas-content pr-2 mr-n3 scroll ps ps--active-y" style="height: 95%;">
                        <!--begin::Header-->
                        <div class="d-flex align-items-center mt-2">
                            <div class="symbol symbol-100 mr-3">
                                <div class="symbol-label" style="background-image:url('images/profile/avatar.png')"></div>
                                <i class="symbol-badge bg-success"></i>
                            </div>
                            <div class="d-flex flex-column">
                                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{bwname}}</a>
                                ...
                                <div class="navi mt-2">
                                    <a href="#" class="navi-item">
                                        <span class="navi-link p-0 pb-2">
                                            ...
                                            <span class="navi-text text-muted text-hover-primary">{{bwemail}}</span>
                                        </span>
                                    </a>
                                    <a href="#" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5 mt-2" @click="logout">Sign Out</a>
                                </div>
                            </div>
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="navi navi-spacer-x-0 p-0">
                            ...
                            <router-link :to="{name: 'edituser'}" class="navi-item" @click.native="hideoverlay">
                                <div class="navi-link">
                        ...
                        <div>
                            <!--begin:Heading-->
                            <h5 class="mb-2">Recent Notifications</h5>
                            <!--end:Heading-->
                            <!--begin::Item-->
                            <div class="d-flex align-items-center bg-light-warning rounded p-2 gutter-b">
                                <span class="svg-icon svg-icon-warning mr-2">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <div class="d-flex align-items-center bg-light-success rounded p-2 gutter-b">
                                <span class="svg-icon svg-icon-success mr-2">
                                    <span class="svg-icon svg-icon-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"></rect>
                            ...
                            <div class="d-flex align-items-center bg-light-info rounded p-2">
                                <span class="svg-icon svg-icon-info mr-2">
                                    <span class="svg-icon svg-icon-lg">
