    ...
    <div id="bw-sidebar" class="bw-sidebar-content reduce open absolute" v-if="fullsidebar" style="width:50px;" @mouseover="hoveropen = true" @mouseleave="hoveropen = false" :class="{ 'hoveropen' : hoveropen }">
        ...
        <div class="bw-sidebar">
            ...
            <div class="bw-sidebar__group" :class="{ 'open' : isOpen }" @click="openClose" >
                ...
                <div class="bw-sidebar__group__content v-enter-to" style="height: 0px;"> <button
                        class="bw-sidebar__item active hasIcon"  v-on:click="setActive('clickfunnels')" :class="{ active:isActive('clickfunnels') }">
                        <div class="bw-sidebar__item__icon"><i class="fas fa-external-link-square-alt"></i></div>
                        <div class="bw-sidebar__item__text">
                            Clickfunnel
                        </div>
                    </button> 
                    <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('kajabi')" :class="{ active:isActive('kajabi') }">
                        <div class="bw-sidebar__item__icon"><i class="fas fa-external-link-square-alt"></i></div>
                        <div class="bw-sidebar__item__text">
                            Kajabi
                        </div>
                    </button> 
                    <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('wordpress')" :class="{ active:isActive('wordpress') }">
                        <div class="bw-sidebar__item__icon"><i class="fas fa-external-link-square-alt"></i></div>
                        <div class="bw-sidebar__item__text">
                            Wordpress
                        </div>
            ...
            <button class="bw-sidebar__item hasIcon"  v-on:click="setActive('affliateprogram')" :class="{ active:isActive('affliateprogram') }">
                <div class="bw-sidebar__item__icon">
