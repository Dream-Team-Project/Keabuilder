<template>
    ...
    <div class="bw-maincontainer pb-5">
        <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <!--begin::Toolbar-->
                <div class="d-flex align-items-center">
                    <!--begin::Button-->
                    <router-link :to="{name: 'dashboard'}" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">
                        Back
                    </router-link>
                    <!--end::Button-->
                    <!--begin::Dropdown-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7 my-2">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="image-input image-input-empty image-input-outline" id="kt_user_edit_avatar" style="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" v-model="bwname" type="text" >
                                            </div>
                                        </div>
                                        <!--end::Group-->
                                        <!--begin::Group-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-9">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg form-control-solid" v-model="bwemail" placeholder="Email">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <select class="form-control form-control-lg form-control-solid">
                                                        <option value="en-gb disabled" disabled selected>English</option>
